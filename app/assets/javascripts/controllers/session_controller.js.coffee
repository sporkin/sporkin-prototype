define [
  ...
  'chaplin/mediator'
  'chaplin'
], (Controller, User, SocialConnectView, Facebook, mediator, c) ->
  'use strict'
  window.c = c
  class SessionController extends Controller
    ...
    createUser: (userData) ->
      ...
      console.log('ccc')
      mediator.user.createWithFacebook userData
    ...
    serviceProviderSession: (session) =>
      ...
      console.log "serviceProviderSession ...."
      @createUser session
